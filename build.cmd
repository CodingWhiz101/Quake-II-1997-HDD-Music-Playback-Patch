...
if not exist "..\wincd.dll" (
  echo Missing ..\wincd.dll. Build it first with ..\_analysis\build.cmd
  goto failed
)
...
if errorlevel 1 goto failed
del /q Q2Win95Prep.res main.obj prep_core.obj prep_io.obj prep_audio.obj prep_copy.obj tests.obj wincd.dll 2>nul
popd
